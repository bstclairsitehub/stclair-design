export default function About() {
  ...
  return (
    <section id="about" className="bg-sc-deep py-24 md:py-36 px-6 md:px-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 max-w-[1300px] mx-auto items-start">
        {/* Left: Text */}
        <div className="reveal">
          ...
          <h2 className="font-serif text-[clamp(32px,5vw,64px)] font-light text-sc-cream leading-[1.15] max-w-[700px] mb-8 md:mb-10">
            Crafting digital <em className="italic text-sc-gold">masterpieces</em>{" "}
            that captivate
          </h2>
          <p className="about-first-letter text-sm md:text-base leading-[1.85] text-sc-text font-light mb-6 md:mb-7">
          ...
          <p className="text-sm md:text-base leading-[1.85] text-sc-text font-light mb-6 md:mb-7">
          ...
          <p className="text-sm md:text-base leading-[1.85] text-sc-text font-light">
        ...
        {/* Right: Stats */}
        <div className="reveal mt-8 md:mt-0 lg:mt-15">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            {stats.map(({ number, label }) => (
              <div
                key={label}
                className="stat-card p-6 md:p-8 border border-sc-border bg-sc-card/50 hoverable"
              >
